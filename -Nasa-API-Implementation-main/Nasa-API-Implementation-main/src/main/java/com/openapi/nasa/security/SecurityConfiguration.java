        ...
        http.authorizeHttpRequests(config ->
                        ...
                        config
                              ...
                              //  .requestMatchers(HttpMethod.GET,"/get-token").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET, "/nasa/home-page").hasAnyAuthority("SCOPE_ROLE_MANAGER","ROLE_MANAGER")
                                .requestMatchers(HttpMethod.GET, "/api/apod").hasAnyAuthority("SCOPE_ROLE_MANAGER","ROLE_MANAGER")
                                .requestMatchers(HttpMethod.GET, "/api/apods").hasAnyAuthority("SCOPE_ROLE_MANAGER","ROLE_MANAGER")
                                .requestMatchers(HttpMethod.GET, "/api/save-apod").hasAnyAuthority("SCOPE_ROLE_MANAGER","ROLE_MANAGER")
                                .requestMatchers(HttpMethod.GET, "/api/apod/**").hasAnyAuthority("SCOPE_ROLE_MANAGER","ROLE_MANAGER")
